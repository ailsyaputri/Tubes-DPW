                    ...
                    <form class="form" action="{{ route('product.update', $data->id) }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                ...
                                <div class="mt-3">
                                    <div class="alert alert-warning d-flex align-items-center" role="alert">
                                        <div>
                                            Gambar hanya JPG dan PNG Maks Size 2 MB
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-7">
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Harga Event</label>
                                ...
                                {{-- <div class="mb-3">
                                    <label class="form-label">Pilih Status Event</label>
                        ...
                        <div class="mb-4">
                            <label for="summernote" class="form-label">Deskripsi Event</label>
